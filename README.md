...
Engenheiro especializado em automação de processos, sistemas internos e integrações entre plataformas.  
Desenho e implemento soluções que conectam sistemas legados e modernos, com foco em confiabilidade, escalabilidade e redução de gargalos operacionais.
...
- 📉 redução de até **80% de custo operacional**
- 📈 aumento de até **100% de produtividade**
...
- 🔄 **Automação de processos**  
  Orquestração de APIs, webhooks e databases em pipelines confiáveis e monitoráveis

- 🧠 **Sistemas internos**  
  Backend escalável para gerenciar operações internas, desde SaaS até ferramentas de gestão proprietárias

- 🔗 **Integrações B2B**  
  Conexão de plataformas heterogêneas através de REST APIs, transformação de dados e sincronização em tempo real

- 🗄️ **Arquitetura de dados**  
  Modelagem PostgreSQL para suportar automações críticas e consultas complexas

- 🤖 **Agentes de IA em produção**  
  Integração de modelos de linguagem em fluxos de automação reais
...
- Design de fluxos e experiência do usuário (UX)
...
- Arquitetura serverless baseada em serviços gerenciados
- Definição de requisitos de infraestrutura por projeto (carga, consumo e limites)
- Análise de capacidade antes de lançamento (volume de usuários, automações e integrações)
- Dimensionamento de configurações para ambientes de produção
- Planejamento de escalabilidade e expansão futura
- Avaliação de riscos operacionais e gargalos de integração
...
Plataforma omnichannel com automações de comunicação e orquestração de atendimentos.
...
### 🧩 IntegraCore — Product Engineer  
`04/2024 – atual`

- Desenvolvimento hands-on de SaaS, sistemas web e agentes de IA (atendimento 24/7)
- Arquitetura e integração de sistemas (ERP, CRM, APIs e serviços externos)
- Automação de fluxos de negócio e validação de MVPs
...
### 🏠 Allp Home — Coordenador de Operações Digitais  
`01/2025 – 01/2026`

- Coordenação das operações digitais
- Interface direta entre produto, tecnologia e conteúdo
- Acompanhamento de desenvolvimento, bugs e melhorias
- Gestão de parceiros e criadores
- Análise de performance de agentes de IA
- Apoio técnico ao suporte
...
- Criação de sistema próprio de controle de ponto
- Redução significativa de trabalho manual da equipe
...
Faculdade Única — `2023 – 2026 (cursando)`
...
- Jira Service Management Agents — Atlassian
- LGPD — Proteção de Dados e Conformidade
- Formação em Liderança — Escola Conquer
- 3CX Basic Certified Engineer — 3CX
- Windows MD-100 / MD-101 — Microsoft
...
- ✅ automações que reduzem carga operacional real
- ✅ escalabilidade desde a arquitetura inicial
